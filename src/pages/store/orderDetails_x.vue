<template>
	<div class="orderd">
		...
		<div v-else class="orderd_box">
          ...
          <template v-if="addslists.server_info.service_value_unit_id == 4 || addslists.server_info.service_value_unit_id == 2">
            <li
              v-if="addslists.server_info.service_value_unit_id == 2">
              <div>服务时长</div>
              <div>{{addslists['server_info']['service_length']}} 小时</div>
            </li>
            <li
              v-if="addslists.server_info.service_value_unit_id == 4">
              <div>服务面积</div>
              <div>{{addslists['server_info']['service_length']}} 平方米</div>
            </li>
          </template>
					...
					<li>
						<div v-if="(addslists.server_info.appointed_row).length > 0">服务人员</div>
